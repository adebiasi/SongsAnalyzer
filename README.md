...
### Retrieve the link of the pages
***song_parser.py*** reads the json generated by ***scraper.py*** to generate a json containing the lyrics + chords. The format of the generated json is:
```json
{
    "artists": [       
        {
...
***extract_song_data.py*** reads the json generated by ***song_parser.py*** to generate a json containing the information about lyrics, the chords, the song structure, etc. The format of the generated json is:
```json
{
    "songs": [       
       {
